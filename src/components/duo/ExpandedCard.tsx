    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="flex-1 px-6 pt-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">{meta.label}</p>
        ...
        <h1 className="text-2xl font-semibold text-foreground mb-2">{card.subject}</h1>
        <p className="text-base text-muted-foreground mb-6">{card.context}</p>

        <div className="space-y-4">
          <div className="flex justify-between py-3 border-b border-border/60">
            <span className="text-sm text-muted-foreground">Time</span>
            <span className="text-sm font-medium text-foreground">{card.time}</span>
          </div>
